# Generated by Django 3.1.14 on 2023-05-25 07:39
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('result', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='trainee_subject.subjectrequisitionresult')),
            ],
            options={
        ...
        migrations.CreateModel(
            name='HistoricalSubjectResultValue',
            fields=[
                ('created', models.DateTimeField(blank=True, default=edc_base.utils.get_utcnow)),
                ('modified', models.DateTimeField(blank=True, default=edc_base.utils.get_utcnow)),
                ('user_created', edc_base.model_fields.userfield.UserField(blank=True, help_text='Updated by admin.save_model', max_length=50, verbose_name='user created')),
                ...
                ('result', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='trainee_subject.subjectrequisitionresult')),
            ],
            options={
        ...
        migrations.CreateModel(
            name='HistoricalSubjectRequisitionResult',
            fields=[
                ('created', models.DateTimeField(blank=True, default=edc_base.utils.get_utcnow)),
                ('modified', models.DateTimeField(blank=True, default=edc_base.utils.get_utcnow)),
                ('user_created', edc_base.model_fields.userfield.UserField(blank=True, help_text='Updated by admin.save_model', max_length=50, verbose_name='user created')),
