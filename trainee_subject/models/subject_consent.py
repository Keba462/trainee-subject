...
class SubjectConsent(SearchSlugModelMixin,ConsentModelMixin, SiteModelMixin,SubjectRecipientModelMixin,
        UpdatesOrCreatesRegistrationModelMixin,
        NonUniqueSubjectIdentifierModelMixin,
        IdentityFieldsMixin, ReviewFieldsMixin, PersonalFieldsMixin,
        CitizenFieldsMixin, BaseUuidModel):

    subject_screening_model = "trainee_subject_subjectscreening"
    ...
    def save(self, *args, **kwargs):
        ...
        screening_cls = django_apps.get_model('trainee_subject.subjectscreening')
        try:
