...
from trainee_subject.choices import YES_NO_DW



class SubjectLocator(BaseUuidModel,SiteModelMixin,LocatorModelMixin, 
                     RequiresConsentFieldsModelMixin,ActionModelMixin):
